<main>
    ...
    <div class="dashboard-container">
        ...
        <form class="content-container" action="<?= FRONT_ROOT ?>show/modify" method="post">
			...
			<label>
				<h4>Id:</h4>
				<input type="number" name="id" value="<?=$show->getId(); ?>">
			</label>
			...
			<label>
                <h4>Modify date:</h4>
                <input type="date" name="date" value="<?= $show->getDateStart(); ?>" required>
            </label>

			<label>
                <h4>Modify hour:</h4>
                <input type="time" name="time" value="<?= $show->getTimeStart(); ?>" required>
            </label>
