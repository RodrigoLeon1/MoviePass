							...
							<tr>
								...
								<td>
									<div class="actions-container">
										...
										<a href="<?= FRONT_ROOT . "cinemaRoom/disable/" . $cinemaRoom->getId(); ?>" class="btn btn-disable">
											<i class="icon ion-md-trash"></i>
											Disable
										</a>			
										<?php else: ?>
										<a href="<?= FRONT_ROOT . "cinemaRoom/enable/" . $cinemaRoom->getId(); ?>" class="btn btn-enable">
											<i class="icon ion-md-done-all"></i>
											Enable
										</a>		
										<?php endif; ?>							
										<a href="<?= FRONT_ROOT . "cinemaRoom/modifyById/" . $cinemaRoom->getId(); ?>" class="btn">
